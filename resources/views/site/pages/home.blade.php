...
<section id="main" class="clearfix home-two">
    <!-- view-ad -->
    <div id="home-section" class="parallax-section1">
        <div class="container">
            <div class="row">
                <div class="col-sm-7">
                    <h1>@lang('Advertise It')</h1>
                    <h2>Australia' Largest Classifieds Portal</h2>
                    <p>@lang('Search from over 15,00,000 classifieds & Post unlimited classifieds free!')</p>
                    <br/><br/><br/>
                    <div class="btn-group">
                 ...
                 <div id="recent" class="tab-pane fade in active">
                    ...
                    <div class="custom-list-item row">
                        ...
                        <div class="item-info col-sm-9">
                            <!-- ad-info -->
                            <div class="ad-info">
                                <h3 class="item-price">{{currency($anAd->item_price,'AUD')}}</h3>
