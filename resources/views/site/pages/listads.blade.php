                                    ...
                                    <div class="panel-body">
                                        <div class="price-range"><!--price-range-->
                                            <div class="price">
                                                ...
                                                ?>
                                                 <span>{{currency($prices[0],'AUD')}} - <strong>{{currency($prices[1],'AUD')}}</strong></span>
                                                ...
                                                @else
                                                <span>{{currency(1000,'AUD')}} - <strong>{{currency(100000,'AUD')}}</strong></span>
                                                <input form="search-bar-form" 
                                                       name='price_range' 
                                                       type="text"
                                                       data-slider-min="1000" 
                    ...
                    <div class="section recommended-ads">
                        ...
                        <div class="custom-list-item row custom-featured">
                            ...
                            <div class="item-info col-sm-8">
                                <!-- ad-info -->
                                <div class="ad-info">
                                    <h3 class="item-price">{{currency($aTopAd->item_price,'AUD')}}</h3>
