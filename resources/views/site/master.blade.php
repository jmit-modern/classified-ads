...
<html prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <title>@lang('AdvertiseIt') | @lang('Australia Best Classifieds Portal')</title>
        @stack('meta')
            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{url('/')}}"><img class="img-responsive" src="{{asset('site-assets/logo/logo_text.png')}}" alt="Logo"></a>
                    </div>
                    <!-- /navbar-header -->
